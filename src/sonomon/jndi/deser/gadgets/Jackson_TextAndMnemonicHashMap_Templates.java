...
public class Jackson_TextAndMnemonicHashMap_Templates implements SerializeObject{
	//jackson4
	...
	public Object getJavaSerializeObject(String payload, String jarname) throws Exception {
        ...
        POJONode pnode = new POJONode(tempImpl);
        POJONode pnode2 = new POJONode(tempImpl);
